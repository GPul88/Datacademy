...
class Function():
    def __init__(self, file_name='iris.csv'):
        ...
        self.working_dir = os.path.join(os.getcwd().split('Datacademy')[0], "Datacademy", "Modules", "M04_ML", "src")
        self.answer_dir = os.path.join(os.getcwd().split('Datacademy')[0], "Datacademy", "Modules", "M04_ML")
